function ScreenComponent() {
  return (
    <div className="screen-container flex flex-col w-3/4 max-md:w-1/2 h-3/5 bg-[#0C0404] rounded-lg p-3 border-2 border-slate-400 overflow-y-scroll space-y-1 animate-floating">
